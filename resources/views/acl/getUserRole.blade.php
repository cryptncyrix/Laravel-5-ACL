...
<div class="container">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
                        <h4>Rollen zum User zuweisen</h4>
			...
			<div class="well well-lg">
					...
					@endif
                                        {!! Form::open(['route' => ['acl.doListUserRoles'], 'class' => 'form-horizontal']) !!}
                                        {!! Form::hidden('_id', $id) !!}
                                        ...
                                        <div class="form-group">
                                            <div class='col-sm-6 col-sm-offset-4'>
                                                <div class="col-sm-4">{!! Form::submit('Rollen zuweisen', ['class' => 'btn btn-primary']) !!}</div>
                                            </div>  
                                        </div>
